...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons"><a onclick="location = '<?php echo $news; ?>';" class="button"><span><?php echo $button_news; ?></span></a><a onclick="$('#form').submit();" class="button"><span><?php echo $button_save; ?></span></a><a onclick="location = '<?php echo $cancel; ?>';" class="button"><span><?php echo $button_cancel; ?></span></a></div>
    </div>
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          <tr>
            ...
            <td><input type="text" name="news_headline_chars" value="<?php echo $news_headline_chars; ?>" size="3" />
          ...
          <tr>
            ...
            <td><input type="text" name="news_thumb_width" value="<?php echo $news_thumb_width; ?>" size="3" />
              x
              <input type="text" name="news_thumb_height" value="<?php echo $news_thumb_height; ?>" size="3" />
          ...
          <tr>
            ...
            <td><input type="text" name="news_popup_width" value="<?php echo $news_popup_width; ?>" size="3" />
              x
              <input type="text" name="news_popup_height" value="<?php echo $news_popup_height; ?>" size="3" />
          ...
          <tr>
            ...
            <td><?php if ($news_headline_module) { ?>
              <input type="radio" name="news_headline_module" value="1" checked="checked" />
              <?php echo $text_yes; ?>
              <input type="radio" name="news_headline_module" value="0" />
              <?php echo $text_no; ?>
              <?php } else { ?>
              <input type="radio" name="news_headline_module" value="1" />
              <?php echo $text_yes; ?>
              <input type="radio" name="news_headline_module" value="0" checked="checked" />
              <?php echo $text_no; ?>
              <?php } ?></td>
          </tr>
        </table>
          ...
          <thead>
            ...
            <tbody id="module-row<?php echo $module_row; ?>">
              <tr>
                ...
                <td class="left"><select name="news_module[<?php echo $module_row; ?>][headline]">
                ...
                <td class="left"><input type="text" name="news_module[<?php echo $module_row; ?>][numchars]" value="<?php echo $module['numchars']; ?>" size="3" /></td>
...
function addModule() {	
    ...
    html += '      <option value="0"><?php echo $text_disabled; ?></option>';
    html += '    </select></td>';
	html += '    <td class="left"><input type="text" name="news_module[' + module_row + '][numchars]" value="" size="3" /></td>';
