...
class ControllerProductCategory extends Controller {  
	public function index() { 
		...
		if ($category_info) {
            ...
            //manufactures
            $manufacturers = $this->model_catalog_category->getManufacturersForFilter($category_id);
            ...
            //sizes
            $sizes = $this->model_catalog_category->getSizesForFilter($category_id);
            ...
            //attributes
            $attributes = $this->model_catalog_category->getAttributesForFilter($category_id);
